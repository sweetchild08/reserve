                            ...
                            <div class="list-icons">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a href="{{route('admin.inventory.category.delete',$cat->encryptedId())}}"
                                            onclick="return confirm('Are you sure want to delete this category?');" class="dropdown-item">Delete</a>
                                    </div>
                                </div>
                            </div>
                        </td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('admin.inventory.category.store')}}" data-parsley-validate method="POST">
                        @csrf
                        <div class="form-group">
    ...
    <div class="modal" id="update_category" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form-update-category" data-parsley-validate method="POST">
                        @method('put')
                        @csrf
                        <div class="form-group">
                            <label for="">Category</label>
