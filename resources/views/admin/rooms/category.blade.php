...
<div class="content pt-0">
                            ...
                            <div class="list-icons">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a href="{{url('admin/rooms/delete')}}/{{Crypt::encryptString($cat->id)}}/category"
    ...
    <!-- Modal -->
    <div class="modal" id="category" tabindex="-1">
        <div class="modal-dialog" role="document">
            <div class="modal-content ">
                ...
                <div class="modal-body">
                    <form action="{{url('admin/rooms/store/category')}}" data-parsley-validate method="POST">
                        @csrf
                        <div class="form-group">
    ...
    <div class="modal" id="update_category" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content ">
                ...
                <div class="modal-body">
                    <form action="{{url('admin/rooms/update/category')}}" data-parsley-validate method="POST">
                        @csrf
                        <div class="form-group">
                            <label for="">Category</label>
                            <input type="text" class="form-control" id="category_update" name="name" required>
                            <input type="hidden" class="form-control" id="rooms_id" name="rooms_id">
                        </div>
                </div>
                <div class="modal-footer">
...
<script>
    ...
    $('#rooms-category').addClass('active')
...
<script src="{{asset('admin/assets/js/plugins/notifications/bootbox.min.js')}}"></script>
<script src="{{asset('admin/assets/js/demo_pages/components_modals.js')}}"></script>
<script>
