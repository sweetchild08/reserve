    ...
    <div class="row">
        <div class="col-md-12 col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{url('admin/rooms/store')}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                <input type="text" name="services" class="form-control tokenfield" value="{{old('services')}}" required data-fouc>
                            </div>
                        </div>
...
{{--                        </div>--}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                <input type="text" name="adults" value="{{old('adults')}}" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                <input type="text" name="childrens" value="{{old('childrens')}}" class="form-control">
                            </div>
                        </div>
