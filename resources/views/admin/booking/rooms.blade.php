                ...
                <tbody>
                    ...
                    @foreach($rooms as $r)
                        <tr>
                            ...
                            <td>
                                <span><?= CheckAvailability::check($r->TabID)['Status'] ?></span> 
                                @if(CheckAvailability::check($r->TabID)['Booked'] !== '.')| 
                                <span>Room Available: <?= date('M. d, Y', strtotime('+1 day',strtotime(CheckAvailability::check($r->TabID)['Booked']))) ?></span>
                                @endif
                            </td>
