                            ...
                            <div class="list-icons">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a href="{{url('admin/cottages/delete')}}/{{Crypt::encryptString($cat->id)}}/category"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{url('admin/cottages/store/category')}}" data-parsley-validate method="POST">
                        @csrf
                        <div class="form-group">
    ...
    <div class="modal" id="update_category" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{url('admin/cottages/update/category')}}" data-parsley-validate method="POST">
                        @csrf
                        <div class="form-group">
                            <label for="">Category</label>
...
<script>
    ...
    $('#cottages-category').addClass('active')
