                                ...
                                <div class="list-icons">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a href="{{url('admin/'.Crypt::encryptString($inventory->id).'/delete/inventory')}}" onclick="return confirm('Are you sure want to delete this item?');"  class="dropdown-item">Delete</a>
                                        </div>
                                    </div>
                                </div>
                            </td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content ">
                ...
                <div class="modal-body">
                    <form action="{{url('admin/store/inventory')}}" data-parsley-validate method="POST">
                    @csrf
    ...
    <div class="modal" id="update_product" tabindex="-1">
        <div class="modal-dialog" role="document">
            <div class="modal-content ">
                ...
                <div class="modal-body">
                    <form action="{{url('admin/update/inventory')}}" data-parsley-validate method="POST">
                    @csrf
