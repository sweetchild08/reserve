...
<div class="content pt-0">
    ...
    <div class="form-group">
        <a href="{{url('admin/events/create-events')}}" class="btn btn-primary btn-sm">Add Events</a>
    </div>
    <div class="card">
                                ...
                                <div class="list-icons">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a href="{{url('admin/events/details')}}/{{Crypt::encryptString($r->id)}}" class="dropdown-item">Update</a>
                                        </div>
                                    </div>
                                </div>
                            </td>
