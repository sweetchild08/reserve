...
<div class="content pt-0">
    ...
    <div class="form-group">
        <a href="{{url('admin/foods/create-foods')}}" class="btn btn-primary btn-sm">Add Foods</a>
    </div>
    <div class="card">
                                ...
                                <div class="list-icons">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a href="{{url('admin/foods/details')}}/{{Crypt::encryptString($r->id)}}" class="dropdown-item">Update</a>
                                        </div>
                                    </div>
                                </div>
                            </td>
