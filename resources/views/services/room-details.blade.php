            ...
            <div class="col-md-8">
                <div class="slider">
                    ...
                    <div id="thumbs" class="owl-carousel">
                        @foreach($gallery as $data)
                        <div class="item"><img class="img-responsive" src="{{asset('assets/images/rooms/'.$data->gallery)}}" alt="Image"></div>
                        @endforeach
                    </div>
                </div>
                        ...
                        <div class="vbf">
                            ...
                            <form method="POST" action="{{url('services/reservation')}}" class="inner">
                                ...
                                <!-- <button class="button btn_lg btn_blue btn_full"
                                    ...
                                    type="submit">BOOK A ROOM NOW</button> -->
                                    <button class="button btn_lg btn_blue btn_full"
                                    onclick="return submit_reservation();"
                                    type="submit">BOOK A ROOM NOW</button>
                                @else
...
<script>
    ...
    function submit_reservation() {
            var status = confirm('Are you sure you want to submit your reservation?');
            ...
            if(status){
                if(terms){
                    ...
                    alert('Please Read the Terms and Condition before proceeding to your reservation.');
                }
            }
            else{
                alert('failed');
