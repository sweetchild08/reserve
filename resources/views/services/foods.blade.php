                  ...
                  <div class="col-lg-4 col-md-5 col-sm-12">
                     <figure>
                        <div  class="room_list_slider owl-carousel">
                           <div class="item">
                              <a href="javascript:void(0)" class=""><img src="{{asset('assets/images/foods/'.$data->image)}}" alt="Image" style="height:230px"></a>
                           </div>
                        </div>
                     </figure>
                  </div>
                     ...
                     <div class="room_details">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12 room_price">
                           <div class="room_price_inner">
                              ...
                              <a href="{{url('foods')}}/{{Crypt::encryptString($data->id)}}/details" class="button btn_blue btn_full upper">Book Now</a>
                           </div>
                        </div>
                     </div>
                  </div>
