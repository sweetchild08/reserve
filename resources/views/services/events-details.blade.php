        ...
        <div class="row">
            <div class="col-md-8">
                <div class="slider">
                    <div id="slider-larg" class="owl-carousel image-gallery">
                        @foreach($gallery as $data)
                            <a href="{{asset('assets/images/events/'.$data->gallery)}}">
                                <img class="img-responsive" style="height:500px" src="{{asset('assets/images/events/'.$data->gallery)}}" alt="Image">
                            </a>
                        @endforeach
                    </div>
                    <div id="thumbs" class="owl-carousel">
                        @foreach($gallery as $data)
                        <div class="item"><img class="img-responsive" style="height:80px;" src="{{asset('assets/images/events/'.$data->gallery)}}" alt="Image"></div>
                        @endforeach
                    </div>
                </div>
                <div class="main_title mt50">
                    <h2 class="text-uppercase">What about this events?</h2>
                </div>
                <p class="text-justify">{{$query->description}}</p>

                <form action="{{url('services/reservation/addons_set_d')}}" method="POST">
                    @csrf
                ...
                <div class="similar_rooms">
                    <div class="main_title t_style5 l_blue s_title a_left">
                        <div class="c_inner">
                            <h2 class="c_title">SIMILAR EVENTS</h2>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <article>
                                <figure>
                                    <a href="{{url('events')}}/{{Crypt::encryptString($data->id)}}/details"
                                        class="hover_effect h_blue h_link"><img
                                            src="{{asset('assets/images/events/'.$data->image)}}" alt="Image"
                                            class="img-responsive"></a>
                                    <figcaption>
                                        <h4 class="text-center"><a
                                                href="{{url('events')}}/{{Crypt::encryptString($data->id)}}/details">{{$data->title}}</a>
                                        </h4>
                                    </figcaption>
                                </figure>
                            </article>
                        ...
                        <div class="vbf">
                            ...
                            <form method="POST" action="{{url('services/reservation')}}" class="inner">
                                ...
                                <button class="button btn_lg btn_blue btn_full"
                                    ...
                                    type="submit">BOOK AN EVENTS NOW</button>
                                @else
