            ...
            <article  class="room_list">
               <div class="row">
                  <div class="col-lg-4 col-md-5 col-sm-12">
                     <figure>
                        <div class="item">
                           <a href="javascript:void(0)"><img src="{{asset('assets/images/activities/'.$data->image)}}" alt="Image" style="height:230px"></a>
                        </div>
                     </figure>
                  </div>
                     ...
                     <div class="room_details">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12 room_price">
                           <div class="room_price_inner">
                              ...
                              <a href="{{url('activities')}}/{{Crypt::encryptString($data->id)}}/details" class="button btn_blue btn_full upper">Book Now</a>
                           </div>
                        </div>
                     </div>
                  </div>
